...
- S09 front-slot lane 0.20 is a clean two-seed front-loss control, not a
  promotion arm. Seed 1001 was positive, but seed 1002 did not
  replicate. Two-seed S09: `0.096357` HV / `0.085650` HV-AUC46 /
  `66/92` coverage vs classic `0.104479` / `0.085867` / `66/92` and V2
  `0.098539` / `0.087146` / `65/92`.
- S22 front-slot lane 0.10 is HV-AUC-positive but not a primary HV win.
  Two-seed S22: `0.101722` HV / `0.089115` HV-AUC46 / `66/92`
...
- S11 `warmup12` closes as a valid one-seed negative warmup
  interpolation control: S11 `0.095807` HV / `0.085702` HV-AUC46 /
  `33/46` coverage vs matched classic `0.111401` / `0.090551` /
  `33/46` and V2 `0.096767` / `0.083539` / `32/46`. It ties classic
