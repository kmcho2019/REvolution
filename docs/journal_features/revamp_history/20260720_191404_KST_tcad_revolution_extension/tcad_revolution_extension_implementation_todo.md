...
Line limit: 140 lines. Keep decisions and current state here; put experiment
detail in the append-only program and candidate histories.
...
- [ ] Add required-data asserts and fail on unknown state.
- [ ] Record all evaluated candidates and preregistered mechanism telemetry.
- [ ] Run `ruff`, focused tests, pyright or recorded existing debt, and `ty`.
- [ ] Complete an independent code-simplicity and isolation audit.
