...
| --- | --- | --- | --- | --- |
| `classic_revolution` | 1001 | `pending` | 0/2 | `exp/auto_bd_research/main_screening_screening_seed3/classic_revolution/seed_1001/standard_results` |
...
- `classic_revolution` seed `1001` `RTLLM`:
