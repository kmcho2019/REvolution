...
| Benchmark Command | 24 | 12 | 0 | 12 | 0 | 0 |
| Arm/Seed | 12 | 0 | 0 | 6 | 1 | 5 |
...
| `landing_smooth_qd_manual_bd` | 1003 | `runs_complete` | 2/2 | `exp/auto_bd_research/main_screening_screening_seed3/landing_smooth_qd_manual_bd/seed_1003/standard_results` |
...
- `random_descriptor_qd` seed `1001` `RTLLM`:
