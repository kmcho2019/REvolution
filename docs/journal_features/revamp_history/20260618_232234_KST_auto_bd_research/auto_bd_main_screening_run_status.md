...
| --- | --- | --- | --- | --- | --- | --- |
| Manifest | 15 | 15 | 0 | 0 | 0 | 0 |
| Benchmark Command | 30 | 30 | 0 | 0 | 0 | 0 |
| Arm/Seed | 15 | 0 | 0 | 0 | 0 | 15 |
...
| `sr_random_relu_pca_qd` | 1001 | `standard_results_complete` | 2/2 | `exp/auto_bd_research/main_screening_screening_seed3/sr_random_relu_pca_qd/seed_1001/standard_results` |
| `sr_random_relu_pca_qd` | 1002 | `standard_results_complete` | 2/2 | `exp/auto_bd_research/main_screening_screening_seed3/sr_random_relu_pca_qd/seed_1002/standard_results` |
| `sr_random_relu_pca_qd` | 1003 | `standard_results_complete` | 2/2 | `exp/auto_bd_research/main_screening_screening_seed3/sr_random_relu_pca_qd/seed_1003/standard_results` |
