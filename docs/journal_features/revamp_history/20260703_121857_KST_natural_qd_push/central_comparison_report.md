...
HV-AUC while keeping functionality? Thirty-three operator-fair live
runs (P0-P3c plus N04/N02b/N07a/N07c/N09/N10 follow-ups), plus the
descriptor extraction smokes, every comparison
operator-audited
...
11. **SR-ReLU PCA follow-up (N10, 2026-07-07)**: the strongest
    descriptor-isolating replay lead is clean but not a win lever. It
    beats classic on mean HV/AUC (111.5% / 108.3%) but trails V2
