...
| `classic_baselines.csv` | Reused operator-fair classic metrics with source tables and run roots. | pinned 2026-07-03; screen seed-1001 row recompute-verified exactly by the P0 anchor package (`../p0_v2_anchor/`); 1002/1003 verify with the replication packaging; 6x7 row recompute-verified by N04 |
