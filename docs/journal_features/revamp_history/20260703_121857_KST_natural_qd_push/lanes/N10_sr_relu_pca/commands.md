...
Preflight:
`preflight_vllm_models_20260707_152537_UTC.json` reports
...
- `--qd_descriptor_file docs/journal_features/revamp_history/20260703_121857_KST_natural_qd_push/lanes/N10_sr_relu_pca/descriptor_profile.yaml`
...
Use the P0 V2 platform command and change only the descriptor file,
descriptor profile, and save path.

```bash
RUN_ROOT=exp/natural_qd_push/n10_sr_relu_pca_<UTC>/live
curl -sS http://20.0.0.103:8000/v1/models \
  > docs/journal_features/revamp_history/20260703_121857_KST_natural_qd_push/lanes/N10_sr_relu_pca/preflight_vllm_models_<UTC>.json
...
uv run python scripts/run_backend.py \
  ...
  --save_path "${RUN_ROOT}/sr_relu_pca_3d/seed_1001"
```
...
uv run python scripts/report_pareto_analysis.py \
  ...
  --backend_run n10_sr_relu_pca=exp/natural_qd_push/n10_sr_relu_pca_20260707_152554_UTC/live/sr_relu_pca_3d/seed_1001 \
  ...
  --output-dir docs/journal_features/revamp_history/20260703_121857_KST_natural_qd_push/lanes/N10_sr_relu_pca/pareto_analysis
...
uv run python scripts/report_ppa_distribution.py \
  ...
  --backend_run n10_sr_relu_pca=exp/natural_qd_push/n10_sr_relu_pca_20260707_152554_UTC/live/sr_relu_pca_3d/seed_1001 \
  --subset-config docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/preliminary_planning/20260625_encoder_config_screening/tables/prelim_screen_subset.yaml \
  --output-dir docs/journal_features/revamp_history/20260703_121857_KST_natural_qd_push/lanes/N10_sr_relu_pca/ppa_distribution

uv run python scripts/report_hv_auc.py \
  --ppa-candidates docs/journal_features/revamp_history/20260703_121857_KST_natural_qd_push/lanes/N10_sr_relu_pca/ppa_distribution/data/ppa_candidates.csv \
  --num-generations 5 \
  --output docs/journal_features/revamp_history/20260703_121857_KST_natural_qd_push/lanes/N10_sr_relu_pca/hv_auc.csv

uv run python scripts/audit_operator_contract.py \
  --ppa-candidates docs/journal_features/revamp_history/20260703_121857_KST_natural_qd_push/lanes/N10_sr_relu_pca/ppa_distribution/data/ppa_candidates.csv \
  --output docs/journal_features/revamp_history/20260703_121857_KST_natural_qd_push/lanes/N10_sr_relu_pca/operator_contract.csv

uv run python scripts/validate_natural_qd_run.py \
  --run-root exp/natural_qd_push/n10_sr_relu_pca_20260707_152554_UTC/live/sr_relu_pca_3d/seed_1001 \
  ...
  --expect-config qd_descriptor_profile=sr_pca_3d \
  --output docs/journal_features/revamp_history/20260703_121857_KST_natural_qd_push/lanes/N10_sr_relu_pca/run_validation.json
```
