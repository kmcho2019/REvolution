...
| S07 | four seeds packaged; final confirmation | Capacity3 is now the leading natural extension: S07 `0.104661` HV / `0.090397` HV-AUC46 / `132/184` coverage vs classic `0.103652` / `0.086993` / `131/184` and V2 `0.099485` / `0.087753` / `133/184`. It clears matched classic on HV, HV-AUC46, and coverage across four seeds, but the final-HV margin is small; finish seed 1005 before any manuscript claim. |
...
1. Finish S07 capacity3 seed 1005 as the current top priority. The
   four-seed read clears matched classic on HV, HV-AUC46, and coverage,
   but needs the registered fifth seed before any TCAD claim.
