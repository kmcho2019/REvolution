...
| `L4` learned encoders | Try Qwen, DeepGate, DeepSeq, NetTAG, CircuitFusion, MGVGA, DE-HNN, DeepCell, AURORA. | T44 now wires a live-safe top-8 subset of T11 graph features into the runtime descriptor registry and passes a one-problem smoke. | Run the T44 full live screen before deciding whether richer fitted T11 projection is worth implementing. |
...
| `L4` | T11 contrastive feature selection, T35 replay coupling, T36 bounded front lane, T37 slot ablation, T38/T39/T40/T41/T42/T43 live hooks, and T44 runtime bridge | T44 is smoke-tested but not yet measured; it is the first runtime descriptor change after the T43 trigger-lane block. | Run T44 full live screen, then decide whether to implement top-16/top-64 fitted T11 projection. | Keep T35 front-seeded only as an upper bound. |
