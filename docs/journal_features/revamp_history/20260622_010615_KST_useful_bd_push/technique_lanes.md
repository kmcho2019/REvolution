...
| `L7` RTL-native descriptors | T15, T60, T61, T62, T63 | T63 completes the first fused live screen as mechanism evidence, not a classic win. | Ablate `operator_timing` or keep RTL-native features as a secondary/reporting archive. | Fused descriptors improve live front/archive evidence without default-reference or PPA-leakage claims. |
