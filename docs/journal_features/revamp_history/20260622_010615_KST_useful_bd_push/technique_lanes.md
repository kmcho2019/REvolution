...
| `L4` learned encoders | Try Qwen, DeepGate, DeepSeq, NetTAG, CircuitFusion, MGVGA, DE-HNN, DeepCell, AURORA. | T37 confirms the T36/T11 structural signal is strongest with exactly one bounded local-front slot; T43 did not change the descriptor and did not activate its staged branch. | Branch exact T11 runtime projection or a true encoder path instead of more parent-pressure-only tuning. |
...
| `L4` | T11 contrastive feature selection, T35 replay coupling, T36 bounded front lane, T37 slot ablation, and T38/T39/T40/T41/T42/T43 live hooks | T43 is `T0` and does not explain the T11 descriptor gap because the staged parent-pressure branch never activated. | Split exact T11 runtime projection or an encoder branch if more L4 work starts. | Keep T35 front-seeded only as an upper bound. |
