...
| `L7` RTL-native descriptors | Use pre-synthesis RTL structure and timing-risk morphology as behavior axes. | T67 improves aggregate valid-PPA count but loses front breadth, unique PPA points, and `Prob153_gshare`. | Do not rerun exact T67. Keep MasterRTL/RTLTimer descriptors, but connect them to front-preserving repair or source selection. |
...
| `L7` | T15 Yosys-SOG, T60/T61 RTLTimer timing-risk, T62 fused descriptors, T63 live screen, T64 operator/timing ablation, T65 secondary-cell audit, T66 coupled parent method, and T67 seeded thought-code method | T67 is measured `T0 diagnostic_yield_positive_front_negative_blocked`: valid-PPA yield rises, but front breadth and gshare coverage fail. | RTL-native cells are interpretable but have not improved live HV/front creation. | Add a front-preserving repair/source-selection mechanism or treat RTL-native cells as secondary evidence beside a stronger archive substrate. |
