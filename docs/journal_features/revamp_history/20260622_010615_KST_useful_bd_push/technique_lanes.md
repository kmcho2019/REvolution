...
| `L4` learned encoders | Try Qwen, DeepGate, DeepSeq, NetTAG, CircuitFusion, MGVGA, DE-HNN, DeepCell, AURORA. | T45 shows compact top-4 T11 runtime graph axes preserve coverage but lose to classic on HV, Pareto points, valid-PPA samples, and best score. T46 is pre-registered as the frozen non-PPA projection follow-up. | Run T46 before richer graph branches; if it fails, move graph features to a secondary archive role or trained encoder. |
...
| `L4` | T11 contrastive feature selection, T35 replay coupling, T36 bounded front lane, T37 slot ablation, T38/T39/T40/T41/T42/T43 live hooks, T44 top-8 runtime bridge, T45 top-4 runtime bridge, and T46 PCA4 projection | T45 is measured and `T0 mixed_diagnostic`; T46 is the pre-registered projection ablation. | Stop direct top-k ranked-axis escalation; run T46, then use graph descriptors only as a secondary archive lane or trained encoder if T46 fails. | Keep T35 front-seeded only as an upper bound. |
