...
| `L7` RTL-native descriptors | Use pre-synthesis RTL structure and timing-risk morphology as behavior axes. | T65 shows pure RTLTimer secondary-cell overlays around T51/T63/T64 still lose Classic on paired front-cell coverage. | Accelerate a coupled MasterRTL/RTLTimer method: descriptors must influence parent choice, repair selection, or cell pressure while headline PPA claims stay reference-complete. |
...
| `L7` | T15 Yosys-SOG, T60/T61 RTLTimer timing-risk, T62 fused descriptors, T63 live screen, T64 operator/timing ablation, T65 secondary-cell audit, and T66 coupled parent method | T65 is measured `T0 diagnostic_secondary_cell_not_promoted`; T66 is pre-registered. | Secondary RTLTimer cells do not beat Classic front-cell coverage on the T51/T63/T64 unique-PPA surface. | Run or review T66 before another live RTL-native spend; do not treat RTLTimer/MasterRTL as direct PPA predictors. |
...
the matched `operator_timing` ablation. Both keep the fused descriptor PPA-free
and report reference-complete PPA, direct raw PPA fronts, and Phase 03.1
viewer artifacts. T64 improves valid-PPA yield, but both live screens lose the
classic headline front metrics. Exact fused RTL-native primary archive
geometry should pause until the generator/archive coupling changes.
...
| `L7` RTL-native descriptors | T15, T60, T61, T62, T63, T64, T65, T66 | T65 completed as a diagnostic secondary-cell audit, not a classic win; T66 is the coupled parent-selection follow-up. | Pause exact primary fused RTL-native axes and pure secondary overlays. Redesign generator/archive coupling. | T66 or a successor improves live front metrics without default-reference or PPA-leakage claims. |
