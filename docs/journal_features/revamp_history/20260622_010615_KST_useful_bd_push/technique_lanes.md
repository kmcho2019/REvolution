...
| `L4` learned encoders | Try Qwen, DeepGate, DeepSeq, NetTAG, CircuitFusion, MGVGA, DE-HNN, DeepCell, AURORA. | T44 shows top-8 T11 runtime graph axes have traffic-light/multi-pipe HV/front signal but yield-gate failure. | Run pre-registered T45 top-4 T11 runtime graph axes before richer fitted projection. |
...
| `L4` | T11 contrastive feature selection, T35 replay coupling, T36 bounded front lane, T37 slot ablation, T38/T39/T40/T41/T42/T43 live hooks, T44 top-8 runtime bridge, and T45 top-4 pre-registration | T44 is measured and `T0 mixed_diagnostic`: it wins HV on traffic-light/multi-pipe but drops ALU and traffic-light valid-PPA yield too much. | Execute T45 to test whether compact graph axes recover yield before top-16/top-64 fitted projection. | Keep T35 front-seeded only as an upper bound. |
...
| 2026-06-22 | `L4/L5` learned encoders and archive coupling | T45 compact T11 runtime graph method card | `advance` | T45 reduces T44's top-8 profile to the first four pre-registered graph axes while keeping the archive substrate, model, subset, seed, budget, operator, and visualization gates fixed. | Run `T45_t11_runtime_top4_graph/commands/live_screen_v0.md`, then package direct PPA and full Phase 03.1 viewer artifacts before assigning a tier. |
