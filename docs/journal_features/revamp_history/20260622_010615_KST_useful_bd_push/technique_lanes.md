...
| `L4` | T11 contrastive feature selection, T35 replay coupling, T36 bounded front lane, T37 slot ablation, T38/T39/T40/T41/T42/T43 live hooks, T44 top-8 runtime bridge, and T45 top-4 runtime bridge | T45 is measured and `T0 mixed_diagnostic`: it avoids the 50% yield warning but loses classic on every primary PPA/QD metric. | Stop direct top-k ranked-axis escalation; test frozen non-PPA graph projection or use graph descriptors only as a secondary archive lane. | Keep T35 front-seeded only as an upper bound. |
