...
| `L4` | T33 Qwen3 preprocessing ladder | Source inventory and view cache packaged. | Whole-file embeddings carry nuisance axes. | Split to a Qwen/encoder branch if dependencies or model runtime expand. |
