...
| `L7` | T15 Yosys-SOG, T60/T61 RTLTimer timing-risk, T62 fused descriptors, T63 live screen, T64 operator/timing ablation, and T65 secondary-cell audit | T65 is measured `T0 diagnostic_secondary_cell_not_promoted`. | Secondary RTLTimer cells do not beat Classic front-cell coverage on the T51/T63/T64 unique-PPA surface. | Redesign archive/generator coupling before another live RTL-native spend; do not treat RTLTimer/MasterRTL as direct PPA predictors. |
...
| `L7` RTL-native descriptors | T15, T60, T61, T62, T63, T64, T65 | T65 completed as a diagnostic secondary-cell audit, not a classic win. | Pause exact primary fused RTL-native axes and pure secondary overlays. Redesign generator/archive coupling. | A redesigned method improves live front metrics without default-reference or PPA-leakage claims. |
