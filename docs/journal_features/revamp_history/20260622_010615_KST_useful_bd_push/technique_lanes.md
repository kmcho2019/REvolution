...
| `L7` RTL-native descriptors | Use pre-synthesis RTL structure and timing-risk morphology as behavior axes. | T72 pre-registers a live T71-cell QD method, and its runtime hook reproduces the full T70 table. | Preflight vLLM and run the bounded T72 hard/tuning screen before any PPA claim. |
...
| `L7` | T15 Yosys-SOG, T60/T61 RTLTimer timing-risk, T62 fused descriptors, T63 live screen, T64 operator/timing ablation, T65 secondary-cell audit, T66 coupled parent method, T67 seeded thought-code method, T68 upstream verification, T69 open-Yosys preprocessing, T70 generated RTL smoke, T71 source-aligned feature map, and T72 source-aligned cell QD | T72 is pre-registered and its exact source-aligned runtime descriptor gate passes the full 19-candidate T70 regression. | RTL-native cells are interpretable, but live descriptor-to-archive utility is still unproven. | Run vLLM preflight and launch the bounded T72 hard/tuning screen before any PPA claim. |
...
| `L7` RTL-native descriptors | T15, T60, T61, T62, T63, T64, T65, T66, T67, T68, T69, T70, T71, T72 | T72 is pre-registered and the exact source-aligned runtime descriptor gate passes. | Run T72 only after vLLM preflight, then package PPA completeness and visualizations. | A successor improves live front metrics without default-reference or PPA-leakage claims. |
