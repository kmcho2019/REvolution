...
| `L4` learned encoders | Try Qwen, DeepGate, DeepSeq, NetTAG, CircuitFusion, MGVGA, DE-HNN, DeepCell, AURORA. | T44 shows top-8 T11 runtime graph axes have traffic-light/multi-pipe HV/front signal but yield-gate failure. | Try fewer or compressed T11 runtime graph axes before richer fitted projection. |
...
| `L4` | T11 contrastive feature selection, T35 replay coupling, T36 bounded front lane, T37 slot ablation, T38/T39/T40/T41/T42/T43 live hooks, and T44 runtime bridge | T44 is measured and `T0 mixed_diagnostic`: it wins HV on traffic-light/multi-pipe but drops ALU and traffic-light valid-PPA yield too much. | Reduce top-8 archive sparsity with a top-3/top-4 or frozen projection T11 runtime profile before top-16/top-64 fitted projection. | Keep T35 front-seeded only as an upper bound. |
