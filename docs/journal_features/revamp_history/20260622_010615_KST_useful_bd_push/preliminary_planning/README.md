...
| `../techniques/T87_front_guarded_rtl_native_memory/` | Swap FG-QDM to the registered source-aligned RTL shape-density descriptor after SR memory fails the random-memory control. | Pre-registered; live smoke pending |
