...
| `20260626_deepgate_delayed_high_exploit_probe/` | Test whether T94's DeepGate descriptor improves when archive pressure is delayed and exploitation pressure is higher. | Pre-registered; live run pending |
