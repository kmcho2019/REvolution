...
| `20260626_front_credit_rf_leafid_fg_qdm_probe/` | Test T97-style front-credit FG-QDM with the validated T83 RF leaf-ID structural descriptor axes. | Pre-registered; descriptor contract probe passes, live smoke pending |
