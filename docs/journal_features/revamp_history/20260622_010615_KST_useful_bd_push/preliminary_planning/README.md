...
| `20260626_aurora_raw_impl_delayed_probe/` | Test the live AURORA-style raw implementation feature representative on the delayed high-exploit QD substrate. | Pre-registered; live run pending |
