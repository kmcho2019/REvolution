...
| `20260626_fg_qdm_contribution_audit/` | Audit whether completed FG-QDM memory lanes produced valid-PPA or front-adding children before any further live spend. | Completed; exact T85/T86/T87 FG-QDM variants are negative, and T97 is only a stricter config-gated follow-up |
