...
| `20260626_rf_deepgate_hybrid_delayed_probe/` | Test a compact hybrid of MasterRTL RF timing model-state and DeepGate pooled netlist embedding axes under the T83 delayed schedule. | Pre-registered; descriptor probe and live run pending |
