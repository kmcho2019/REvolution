...
| `classic_revolution_8x5` | VerilogEval-Spec-to-RTL | 3 | 3 | 0.1329 ± 0.2602 | 2.67 ± 3.27 | 3.67 ± 2.85 | 3 |
...
| Backend | Benchmark | Problems | Pareto-Valid Problems | Mean Hypervolume ± CI | Mean Pareto Points ± CI | Mean Ref-Beating ± CI | HV Wins |
|:---|:---|---:|---:|:---|:---|:---|---:|
| `classic_revolution_8x5` | ALL | 8 | 8 | 0.1406 ± 0.1116 | 3.25 ± 1.77 | 8.00 ± 7.71 | 7 |
