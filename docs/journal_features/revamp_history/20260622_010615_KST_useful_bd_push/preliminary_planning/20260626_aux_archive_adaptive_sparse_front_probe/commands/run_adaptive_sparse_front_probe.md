...
```bash
RUN_ROOT="exp/useful_bd_push/prelim_adaptive_sparse_front_20260626_013437_UTC/live"
...
env OPENAI_API_KEY=vllm-local-placeholder PYTHONPATH=src uv run python scripts/run_backend.py \
  ...
  --save_path "$RUN_ROOT/masterrtl_aux_archive_adaptive_sparse_front_8x5/seed_1001"
```
