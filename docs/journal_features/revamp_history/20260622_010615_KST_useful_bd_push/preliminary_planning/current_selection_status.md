...
| MasterRTL RF timing model-state | Pretrained RF timing flow has a runtime descriptor hook and a frozen `8x5` screen. | Not promoted as-is: mean HV `0.1140` versus classic `0.1406`. |
