# RF Timing-State Screen Commands

## Live Screen

```bash
RUN_ROOT=exp/useful_bd_push/prelim_rf_timing_state_screen_20260626_0442_UTC/live
...
PYTHONPATH=src uv run python scripts/run_backend.py \
  ...
  --save_path "$RUN_ROOT/masterrtl_rf_timing_state_8x5/seed_1001"
```
...
uv run python scripts/validate_pareto_front_run.py \
  --run-root exp/useful_bd_push/prelim_rf_timing_state_screen_20260626_0442_UTC/live \
  ...
  --pareto-qd-mode masterrtl_rf_timing_state_8x5/seed_1001/openai_gpt-oss-120b
```

```bash
uv run python scripts/validate_single_thought_operator_run.py \
  --run-root exp/useful_bd_push/prelim_rf_timing_state_screen_20260626_0442_UTC/live \
  --classic-mode masterrtl_rf_timing_state_8x5 \
  --eoh-mode masterrtl_rf_timing_state_8x5 \
  --unified-mode masterrtl_rf_timing_state_8x5 \
  --subset-config docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/preliminary_planning/20260625_encoder_config_screening/tables/prelim_screen_subset.yaml \
  --require-full-subset
```
...
uv run python scripts/report_pareto_analysis.py \
  ...
  --backend_run masterrtl_rf_timing_state_8x5=exp/useful_bd_push/prelim_rf_timing_state_screen_20260626_0442_UTC/live/masterrtl_rf_timing_state_8x5/seed_1001 \
  --subset-config docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/preliminary_planning/20260625_encoder_config_screening/tables/prelim_screen_subset.yaml \
  --output-dir docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/preliminary_planning/20260626_masterrtl_rf_timing_state_screen/analysis/pareto_analysis
```
