# T60 Retrospective Proxy Audit Commands
...
uv run python scripts/package_rtl_timer_timing_risk_audit.py \
  ...
  --output-dir docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T60_rtl_timer_timing_risk_bd
```
...
uv run python scripts/report_ppa_completeness.py \
  ...
  --output docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T60_rtl_timer_timing_risk_bd/tables/ppa_completeness.csv
```
