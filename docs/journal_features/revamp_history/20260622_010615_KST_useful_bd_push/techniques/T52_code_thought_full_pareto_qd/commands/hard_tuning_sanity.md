# T52 Hard/Tuning Sanity Commands
...
RUN_ROOT="exp/useful_bd_push/t52_code_thought_full_pareto_${RUN_TS}/hard_tuning"
...
uv run python scripts/run_backend.py \
  ...
  --save_path "${RUN_ROOT}/code_thought_full_pareto_qd/seed_${SEED}"
```
...
uv run python scripts/validate_single_thought_operator_run.py \
  --run-root "${RUN_ROOT}" \
  --subset-config docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T52_code_thought_full_pareto_qd/tables/hard_tuning_subset.yaml \
  --classic-mode code_thought_full_pareto_qd \
  --eoh-mode code_thought_full_pareto_qd \
  --unified-mode code_thought_full_pareto_qd \
  --require-full-subset
...
uv run python scripts/validate_pareto_front_run.py \
  ...
  --subset-config docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T52_code_thought_full_pareto_qd/tables/hard_tuning_subset.yaml \
  --classic-mode code_thought_full_pareto_qd \
  --pareto-qd-mode code_thought_full_pareto_qd \
  --require-full-subset
```
...
uv run python scripts/package_t48_gated_probe.py \
  ...
  --qd-root "${RUN_ROOT}/code_thought_full_pareto_qd" \
  ...
  --output-dir docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T52_code_thought_full_pareto_qd/hard_tuning_package \
  --seed 1001 \
  --package-tag t52 \
  --package-title "T52 Code-Thought Full-Pareto QD" \
  --qd-method code_thought_full_pareto_qd \
  --qd-label "T52 code-thought full-Pareto QD" \
