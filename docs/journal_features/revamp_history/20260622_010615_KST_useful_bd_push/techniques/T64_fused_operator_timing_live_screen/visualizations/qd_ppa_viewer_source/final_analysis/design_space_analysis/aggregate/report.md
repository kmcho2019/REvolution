...
- [overall / combinational / classic vs fused_rtl_operator_timing_qd](#overall-combinational-classic-vs-fused_rtl_operator_timing_qd)
...
- [overall / sequential / classic vs fused_rtl_operator_timing_qd](#overall-sequential-classic-vs-fused_rtl_operator_timing_qd)
...
- [RTLLM / combinational / classic vs fused_rtl_operator_timing_qd](#rtllm-combinational-classic-vs-fused_rtl_operator_timing_qd)
...
- [RTLLM / sequential / classic vs fused_rtl_operator_timing_qd](#rtllm-sequential-classic-vs-fused_rtl_operator_timing_qd)
...
- [VerilogEval-Spec-to-RTL / combinational / classic vs fused_rtl_operator_timing_qd](#verilogeval-spec-to-rtl-combinational-classic-vs-fused_rtl_operator_timing_qd)
...
- [VerilogEval-Spec-to-RTL / sequential / classic vs fused_rtl_operator_timing_qd](#verilogeval-spec-to-rtl-sequential-classic-vs-fused_rtl_operator_timing_qd)
...
## overall / combinational / classic vs fused_rtl_operator_timing_qd

- feature basis: `fused_rtl_operator_timing_2d descriptor profile`
- features: `operator_mix_score, timing_risk_score`

- `PCA`: ![](overall_combinational_classic_vs_fused_rtl_operator_timing_qd_features_pca.png)
...
## overall / sequential / classic vs fused_rtl_operator_timing_qd

- feature basis: `fused_rtl_operator_timing_2d descriptor profile`
- features: `operator_mix_score, timing_risk_score`

- `PCA`: ![](overall_sequential_classic_vs_fused_rtl_operator_timing_qd_features_pca.png)
...
## RTLLM / combinational / classic vs fused_rtl_operator_timing_qd

- feature basis: `fused_rtl_operator_timing_2d descriptor profile`
- features: `operator_mix_score, timing_risk_score`

- `PCA`: ![](RTLLM_combinational_classic_vs_fused_rtl_operator_timing_qd_features_pca.png)
...
## RTLLM / sequential / classic vs fused_rtl_operator_timing_qd

- feature basis: `fused_rtl_operator_timing_2d descriptor profile`
- features: `operator_mix_score, timing_risk_score`

- `PCA`: ![](RTLLM_sequential_classic_vs_fused_rtl_operator_timing_qd_features_pca.png)
...
## VerilogEval-Spec-to-RTL / combinational / classic vs fused_rtl_operator_timing_qd

- feature basis: `fused_rtl_operator_timing_2d descriptor profile`
- features: `operator_mix_score, timing_risk_score`

- `PCA`: ![](VerilogEval-Spec-to-RTL_combinational_classic_vs_fused_rtl_operator_timing_qd_features_pca.png)
...
## VerilogEval-Spec-to-RTL / sequential / classic vs fused_rtl_operator_timing_qd

- feature basis: `fused_rtl_operator_timing_2d descriptor profile`
- features: `operator_mix_score, timing_risk_score`

- `PCA`: ![](VerilogEval-Spec-to-RTL_sequential_classic_vs_fused_rtl_operator_timing_qd_features_pca.png)
