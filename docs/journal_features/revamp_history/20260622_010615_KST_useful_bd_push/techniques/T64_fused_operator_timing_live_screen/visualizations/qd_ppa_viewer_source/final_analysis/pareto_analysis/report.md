...
- subset_config: `/workspace/docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T64_fused_operator_timing_live_screen/tables/hard_tuning_subset.yaml`
- backend_count: `2`
...
| `classic` | RTLLM | 7 | 7 | 0.1152 | 2.71 | 5.29 | 6 |
| `classic` | VerilogEval-Spec-to-RTL | 6 | 6 | 0.0663 | 1.83 | 1.50 | 4 |
| `fused_rtl_operator_timing_qd` | ALL | 13 | 13 | 0.0846 | 1.77 | 2.92 | 3 |
| `fused_rtl_operator_timing_qd` | RTLLM | 7 | 7 | 0.1000 | 1.71 | 4.00 | 1 |
| `fused_rtl_operator_timing_qd` | VerilogEval-Spec-to-RTL | 6 | 6 | 0.0665 | 1.83 | 1.67 | 2 |
...
| `fused_rtl_operator_timing_qd` | RTLLM | Prob004_adder_8bit | 2 | 1 | 1 | 0.1510 | 1 |
| `classic` | RTLLM | Prob015_multi_pipe_8bit | 3 | 11 | 9 | 0.0000 | 0 |
| `fused_rtl_operator_timing_qd` | RTLLM | Prob015_multi_pipe_8bit | 3 | 6 | 1 | 0.0000 | 0 |
| `classic` | RTLLM | Prob024_fsm | 2 | 11 | 2 | 0.1449 | 8 |
| `fused_rtl_operator_timing_qd` | RTLLM | Prob024_fsm | 2 | 7 | 2 | 0.1459 | 4 |
| `classic` | RTLLM | Prob037_parallel2serial | 3 | 6 | 1 | 0.0003 | 1 |
| `fused_rtl_operator_timing_qd` | RTLLM | Prob037_parallel2serial | 3 | 2 | 2 | 0.0000 | 0 |
| `classic` | RTLLM | Prob041_traffic_light | 2 | 15 | 2 | 0.3067 | 14 |
| `fused_rtl_operator_timing_qd` | RTLLM | Prob041_traffic_light | 2 | 16 | 2 | 0.2214 | 10 |
| `classic` | RTLLM | Prob045_alu | 2 | 9 | 1 | 0.1904 | 9 |
| `fused_rtl_operator_timing_qd` | RTLLM | Prob045_alu | 2 | 11 | 2 | 0.1719 | 11 |
| `classic` | RTLLM | Prob049_signal_generator | 3 | 5 | 3 | 0.0128 | 3 |
| `fused_rtl_operator_timing_qd` | RTLLM | Prob049_signal_generator | 3 | 2 | 2 | 0.0100 | 2 |
| `classic` | VerilogEval-Spec-to-RTL | Prob098_circuit7 | 2 | 2 | 1 | 0.0000 | 1 |
| `fused_rtl_operator_timing_qd` | VerilogEval-Spec-to-RTL | Prob098_circuit7 | 2 | 2 | 1 | 0.0000 | 1 |
| `classic` | VerilogEval-Spec-to-RTL | Prob116_m2014_q3 | 2 | 5 | 2 | 0.3975 | 5 |
| `fused_rtl_operator_timing_qd` | VerilogEval-Spec-to-RTL | Prob116_m2014_q3 | 2 | 3 | 1 | 0.3984 | 3 |
| `classic` | VerilogEval-Spec-to-RTL | Prob135_m2014_q6b | 2 | 3 | 1 | 0.0000 | 0 |
| `fused_rtl_operator_timing_qd` | VerilogEval-Spec-to-RTL | Prob135_m2014_q6b | 2 | 3 | 1 | 0.0000 | 0 |
| `classic` | VerilogEval-Spec-to-RTL | Prob150_review2015_fsmonehot | 2 | 3 | 1 | 0.0000 | 2 |
| `fused_rtl_operator_timing_qd` | VerilogEval-Spec-to-RTL | Prob150_review2015_fsmonehot | 2 | 2 | 1 | 0.0000 | 2 |
| `classic` | VerilogEval-Spec-to-RTL | Prob151_review2015_fsm | 3 | 2 | 2 | 0.0000 | 0 |
| `fused_rtl_operator_timing_qd` | VerilogEval-Spec-to-RTL | Prob151_review2015_fsm | 3 | 5 | 2 | 0.0000 | 0 |
| `classic` | VerilogEval-Spec-to-RTL | Prob153_gshare | 3 | 8 | 4 | 0.0002 | 1 |
| `fused_rtl_operator_timing_qd` | VerilogEval-Spec-to-RTL | Prob153_gshare | 3 | 14 | 5 | 0.0009 | 4 |
