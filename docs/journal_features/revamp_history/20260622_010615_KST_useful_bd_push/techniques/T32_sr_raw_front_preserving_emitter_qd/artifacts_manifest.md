...
| Planned run root | `exp/useful_bd_push/t32_sr_raw_front_preserving_emitter_qd_<RUN_TS>/` |
| Seed | `1001` |
...
- run matrix with resolved T32 root and status;
- T32 Pareto archive validation report;
- direct raw PPA-front figures and visual inspection notes;
- candidate-level raw PPA/front table for figure regeneration;
