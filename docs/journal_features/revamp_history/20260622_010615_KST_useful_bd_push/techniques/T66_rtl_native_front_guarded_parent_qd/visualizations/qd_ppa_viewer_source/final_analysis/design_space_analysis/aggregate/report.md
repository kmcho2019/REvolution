...
- [overall / combinational / classic vs rtl_native_front_guarded_parent_qd](#overall-combinational-classic-vs-rtl_native_front_guarded_parent_qd)
...
- [overall / sequential / classic vs rtl_native_front_guarded_parent_qd](#overall-sequential-classic-vs-rtl_native_front_guarded_parent_qd)
...
- [RTLLM / combinational / classic vs rtl_native_front_guarded_parent_qd](#rtllm-combinational-classic-vs-rtl_native_front_guarded_parent_qd)
...
- [RTLLM / sequential / classic vs rtl_native_front_guarded_parent_qd](#rtllm-sequential-classic-vs-rtl_native_front_guarded_parent_qd)
...
- [VerilogEval-Spec-to-RTL / combinational / classic vs rtl_native_front_guarded_parent_qd](#verilogeval-spec-to-rtl-combinational-classic-vs-rtl_native_front_guarded_parent_qd)
...
- [VerilogEval-Spec-to-RTL / sequential / classic vs rtl_native_front_guarded_parent_qd](#verilogeval-spec-to-rtl-sequential-classic-vs-rtl_native_front_guarded_parent_qd)
...
## overall / combinational / classic vs rtl_native_front_guarded_parent_qd

- feature basis: `fused_rtl_state_pipeline_2d descriptor profile`
- features: `state_control_ratio, control_pipeline_ratio`

- `PCA`: ![](overall_combinational_classic_vs_rtl_native_front_guarded_parent_qd_features_pca.png)
...
## overall / sequential / classic vs rtl_native_front_guarded_parent_qd

- feature basis: `fused_rtl_state_pipeline_2d descriptor profile`
- features: `state_control_ratio, control_pipeline_ratio`

- `PCA`: ![](overall_sequential_classic_vs_rtl_native_front_guarded_parent_qd_features_pca.png)
...
## RTLLM / combinational / classic vs rtl_native_front_guarded_parent_qd

- feature basis: `fused_rtl_state_pipeline_2d descriptor profile`
- features: `state_control_ratio, control_pipeline_ratio`

- `PCA`: ![](RTLLM_combinational_classic_vs_rtl_native_front_guarded_parent_qd_features_pca.png)
...
## RTLLM / sequential / classic vs rtl_native_front_guarded_parent_qd

- feature basis: `fused_rtl_state_pipeline_2d descriptor profile`
- features: `state_control_ratio, control_pipeline_ratio`

- `PCA`: ![](RTLLM_sequential_classic_vs_rtl_native_front_guarded_parent_qd_features_pca.png)
...
## VerilogEval-Spec-to-RTL / combinational / classic vs rtl_native_front_guarded_parent_qd

- feature basis: `fused_rtl_state_pipeline_2d descriptor profile`
- features: `state_control_ratio, control_pipeline_ratio`

- `PCA`: ![](VerilogEval-Spec-to-RTL_combinational_classic_vs_rtl_native_front_guarded_parent_qd_features_pca.png)
...
## VerilogEval-Spec-to-RTL / sequential / classic vs rtl_native_front_guarded_parent_qd

- feature basis: `fused_rtl_state_pipeline_2d descriptor profile`
- features: `state_control_ratio, control_pipeline_ratio`

- `PCA`: ![](VerilogEval-Spec-to-RTL_sequential_classic_vs_rtl_native_front_guarded_parent_qd_features_pca.png)
