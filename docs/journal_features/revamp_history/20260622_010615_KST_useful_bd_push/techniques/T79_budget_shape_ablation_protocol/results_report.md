...
complete. The matched QD `6x7` arm is running. No budget-shape result is
...
| Live arms | `5/6` complete, `1/6` running |
...
| `shape_density_front_pressure_qd_6x7` | running | pending | `48` | pending | pending |
