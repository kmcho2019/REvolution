...
| --- | ---: | --- | --- |
| `12x3` | `48` | complete | planned |
| `8x5` | `48` | planned | planned |
...
The completed arm is recorded in `tables/t79_live_arm_status.csv`. It is the
classic `12x3` baseline only, so it is not a budget-shape or QD comparison.
