...
| --- | --- | --- | ---: | --- |
| `RTLLM` | `Prob045_alu` | `combinational` | 38 | [figures/all_backends/RTLLM/Prob045_alu](figures/all_backends/RTLLM/Prob045_alu) |
| `RTLLM` | `Prob041_traffic_light` | `combinational` | 25 | [figures/all_backends/RTLLM/Prob041_traffic_light](figures/all_backends/RTLLM/Prob041_traffic_light) |
| `RTLLM` | `Prob015_multi_pipe_8bit` | `sequential` | 28 | [figures/all_backends/RTLLM/Prob015_multi_pipe_8bit](figures/all_backends/RTLLM/Prob015_multi_pipe_8bit) |
