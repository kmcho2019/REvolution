...
uv run python scripts/qd_descriptor_probe.py \
  ...
  > docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T74_shape_density_front_slot_hybrid_qd/tables/descriptor_probe_source_aligned_shape_density_3d.json
```
...
RUN_ROOT="exp/useful_bd_push/t74_shape_density_front_slot_hybrid_${RUN_TS}/hard_tuning"
...
uv run python scripts/run_backend.py \
  ...
  --save_path "${RUN_ROOT}/shape_density_front_slot_hybrid_qd/seed_${SEED}"
```
...
uv run python scripts/validate_single_thought_operator_run.py \
  ...
  --classic-mode shape_density_front_slot_hybrid_qd \
  --eoh-mode shape_density_front_slot_hybrid_qd \
  --unified-mode shape_density_front_slot_hybrid_qd \
  --require-full-subset
...
uv run python scripts/validate_pareto_front_run.py \
  ...
  --subset-config docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T72_source_aligned_rtl_cell_qd/tables/hard_tuning_subset.yaml \
  --classic-mode shape_density_front_slot_hybrid_qd \
  --pareto-qd-mode shape_density_front_slot_hybrid_qd \
  --require-full-subset
```

## Two-Parent Descriptor Audit

```bash
uv run python docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T74_shape_density_front_slot_hybrid_qd/tools/audit_t74_two_parent_pairs.py \
  --run-root "${RUN_ROOT}/shape_density_front_slot_hybrid_qd/seed_${SEED}" \
  --output-dir docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T74_shape_density_front_slot_hybrid_qd/tables
```

This writes:

- `tables/t74_two_parent_descriptor_audit.csv`;
- `tables/t74_two_parent_descriptor_audit_summary.json`.

The summary must report whether realized two-parent descendants have parent
descriptor distance `<= 6.75`, the engine threshold for
...
uv run python scripts/export_qd_ppa_visualization.py \
  ...
  --backend_run source_aligned_shape_density_qd=exp/useful_bd_push/t73_source_aligned_shape_density_20260623_232844_UTC/hard_tuning/source_aligned_shape_density_qd/seed_1001 \
  --backend_run shape_density_front_slot_hybrid_qd="${RUN_ROOT}/shape_density_front_slot_hybrid_qd/seed_${SEED}" \
  --archive_source_backend shape_density_front_slot_hybrid_qd \
  --subset-config docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T72_source_aligned_rtl_cell_qd/tables/hard_tuning_subset.yaml \
  --output-dir docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T74_shape_density_front_slot_hybrid_qd/matched_classic_comparison/visualizations/qd_ppa_viewer \
  --strict
...
The committed package must include `ppa_completeness.csv`, direct PPA-front
figures, visual inspection notes, and the Phase 03.1 `qd_ppa_viewer/` bundle if
