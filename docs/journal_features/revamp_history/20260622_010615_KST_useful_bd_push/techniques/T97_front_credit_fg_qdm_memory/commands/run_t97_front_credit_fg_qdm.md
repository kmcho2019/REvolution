# T97 Front-Credit FG-QDM Commands

## VLLM Preflight

```bash
mkdir -p exp/useful_bd_push/front_credit_fg_qdm_20260626/preflight
...
uv run python scripts/validate_pareto_front_run.py \
  --run-root exp/useful_bd_push/front_credit_fg_qdm_20260626 \
  ...
  --pareto-qd-mode fg_qdm_sr_front_credit_12x3/seed_1001/openai_gpt-oss-120b

uv run python scripts/validate_single_thought_operator_run.py \
  --run-root exp/useful_bd_push/front_credit_fg_qdm_20260626 \
  --subset-config docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/preliminary_planning/20260626_front_guarded_qd_memory_probe/tables/smoke_subset.yaml \
  --classic-mode fg_qdm_sr_front_credit_12x3 \
  --eoh-mode fg_qdm_sr_front_credit_12x3 \
  --unified-mode fg_qdm_sr_front_credit_12x3
```

## Reports

The analysis reports compare T97 against classic and the existing FG-QDM smoke
controls:
