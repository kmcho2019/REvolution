...
- Skipped automatic graph recovery for graph-backed features `hyper_mean_fanout, edge_per_node, log_edge_count, hyper_directed_edge_count, hyper_fanout_entropy, hyper_driven_net_count, hyper_sink_net_count, log_net_count`; cached QD descriptor values are still used when present.
