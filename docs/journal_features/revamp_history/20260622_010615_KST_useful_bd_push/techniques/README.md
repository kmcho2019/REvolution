...
| `T57` | `T57_t51_adaptive_rebin_qd` | Archive-coupling adaptive rebinning | Pre-registered T51-preserving adaptive-rebin ablation; changes only KS-triggered grid-quantile rebinning |
