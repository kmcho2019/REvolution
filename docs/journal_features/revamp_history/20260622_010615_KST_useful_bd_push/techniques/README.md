...
| `T50` | `T50_candidate_matched_thought_front_qd` | Archive-coupling candidate/front control | Pre-registered T49 follow-up; restores the 12-candidate evaluated-code budget and widens local Pareto retention |
