...
| `T82` | `T82_masterrtl_rf_timing_runtime_hook` | RTL-native pretrained model runtime hook | Completed `T0_runtime_hook_positive_not_live_screened`; RF timing model-state metrics now resolve through the live descriptor registry |
