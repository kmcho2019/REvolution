...
| `T74` | `T74_shape_density_front_slot_hybrid_qd` | RTL-native archive coupling | Pre-registered; applies `near_front_descriptor` gating to T73's low-rate single-thought two-parent prompts |
