...
| `T73` | `T73_source_aligned_shape_density_qd` | RTL-native archive coupling | Valid bounded screen; 12/13 success, one zero-member problem, matched classic comparison pending |
