...
| `T33` | `T33_qwen3_preprocessing_ladder_bd` | Learned/projection descriptor | Source inventory, preprocessing cache, and embeddings complete; collapse/replay pending |
