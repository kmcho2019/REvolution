...
- run root pattern:
  `exp/useful_bd_push/t43_staged_sparse_yield_gate_qd_${RUN_TS}/`
- runtime outputs stay under `exp/`, not `/aux`.

## Committed Setup Artifacts
...
- `tables/live_runtime_summary.csv`
- `tables/preflight_models_<RUN_TS>.json`
- `tables/staged_sparse_yield_gate_qd_validation.{json,md}`
- `tables/t43_candidate_ppa_points.csv`
- `tables/t43_problem_method_summary.csv`
- `tables/t43_method_manifest.csv`
...
Hashes must be recorded here after the live result is packaged.
