# Motif Pathlet BD Artifacts Manifest

Status: current replay package for `T02_motif_pathlet_bd`.

## Scope Caveat

This package reuses the historical `netlist_motif_occupancy` seed-1
standard-results arm as a partial motif/pathlet diagnostic. It does not include
the not-yet-run full pathlet, reconvergence, SVD, or CVT variant.

## Source Artifacts

- Historical standard-results root:
  `/aux/revolution-history/.worktrees/journal-auto-bd-exp-20260618/exp/auto_bd_research/development_preliminary_seed1/netlist_motif_occupancy/seed_1001/standard_results`
- Baseline root:
...
- Prior method card:
  `docs/journal_features/revamp_history/20260618_232234_KST_auto_bd_research/auto_bd_methods/02_netlist_motif_occupancy/`
...
.venv/bin/python scripts/package_useful_bd_replay_method.py \
  ...
  --method-name netlist_motif_occupancy \
  --technique-dir docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T02_motif_pathlet_bd
```
