...
- [overall / combinational / classic vs t11_runtime_top4_graph_qd](#overall-combinational-classic-vs-t11_runtime_top4_graph_qd)
...
- [overall / sequential / classic vs t11_runtime_top4_graph_qd](#overall-sequential-classic-vs-t11_runtime_top4_graph_qd)
...
- [RTLLM / combinational / classic vs t11_runtime_top4_graph_qd](#rtllm-combinational-classic-vs-t11_runtime_top4_graph_qd)
...
- [RTLLM / sequential / classic vs t11_runtime_top4_graph_qd](#rtllm-sequential-classic-vs-t11_runtime_top4_graph_qd)
...
## overall / combinational / classic vs t11_runtime_top4_graph_qd

- feature basis: `t11_runtime_top4_graph descriptor profile`
- features: `hyper_mean_fanout, edge_per_node, log_edge_count, hyper_directed_edge_count`

- `PCA`: ![](overall_combinational_classic_vs_t11_runtime_top4_graph_qd_features_pca.png)
...
## overall / sequential / classic vs t11_runtime_top4_graph_qd

- feature basis: `t11_runtime_top4_graph descriptor profile`
- features: `hyper_mean_fanout, edge_per_node, log_edge_count, hyper_directed_edge_count`

- `PCA`: ![](overall_sequential_classic_vs_t11_runtime_top4_graph_qd_features_pca.png)
...
## RTLLM / combinational / classic vs t11_runtime_top4_graph_qd

- feature basis: `t11_runtime_top4_graph descriptor profile`
- features: `hyper_mean_fanout, edge_per_node, log_edge_count, hyper_directed_edge_count`

- `PCA`: ![](RTLLM_combinational_classic_vs_t11_runtime_top4_graph_qd_features_pca.png)
...
## RTLLM / sequential / classic vs t11_runtime_top4_graph_qd

- feature basis: `t11_runtime_top4_graph descriptor profile`
- features: `hyper_mean_fanout, edge_per_node, log_edge_count, hyper_directed_edge_count`

- `PCA`: ![](RTLLM_sequential_classic_vs_t11_runtime_top4_graph_qd_features_pca.png)
