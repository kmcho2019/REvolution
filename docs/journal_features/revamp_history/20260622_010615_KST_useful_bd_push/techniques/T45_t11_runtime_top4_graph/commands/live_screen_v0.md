# T45 Live Screen V0 Commands

Run preflight first:

```bash
RUN_TS="$(date -u +%Y%m%d_%H%M%S_UTC)"
RUN_ROOT="exp/useful_bd_push/t45_t11_runtime_top4_graph_${RUN_TS}"
...
T45 compact T11 runtime graph QD:
...
uv run python scripts/run_backend.py \
  ...
  --representation_kind code_individual \
  --save_path "${RUN_ROOT}/t11_runtime_top4_graph_qd/seed_1001"
```
...
uv run python scripts/validate_pareto_front_run.py \
  ...
  --pareto-qd-mode t11_runtime_top4_graph_qd \
  --require-full-subset
```
...
```bash
uv run python scripts/package_t45_t11_runtime_top4_graph.py \
  --t45-run-root "${RUN_ROOT}" \
  ...
  --output-dir docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T45_t11_runtime_top4_graph
```
...
uv run python scripts/report_final_analysis_bundle.py \
  ...
  --backend_run t11_runtime_top4_graph_qd="${RUN_ROOT}/t11_runtime_top4_graph_qd/seed_1001" \
  --subset-config docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T45_t11_runtime_top4_graph/tables/live_screen_v0_subset.yaml \
...
```bash
VIEWER_SOURCE="docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T45_t11_runtime_top4_graph/visualizations/qd_ppa_viewer_source"
...
uv run python scripts/export_qd_ppa_visualization.py \
  --run-root docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T45_t11_runtime_top4_graph/visualizations/qd_ppa_viewer_source \
  --backend_run classic="${RUN_ROOT}/classic_revolution/seed_1001" \
  --backend_run t11_runtime_top4_graph_qd="${RUN_ROOT}/t11_runtime_top4_graph_qd/seed_1001" \
  --archive_source_backend t11_runtime_top4_graph_qd \
  --subset-config docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T45_t11_runtime_top4_graph/tables/live_screen_v0_subset.yaml \
  --output-dir docs/journal_features/revamp_history/20260622_010615_KST_useful_bd_push/techniques/T45_t11_runtime_top4_graph/visualizations/qd_ppa_viewer \
  --strict
