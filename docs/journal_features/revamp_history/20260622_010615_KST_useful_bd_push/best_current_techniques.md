...
| 3 | T63 fused RTL-native QD | Mechanism ablation | Adds RTLLM front, unique-PPA, and reference-beating signal versus T51 while using reviewer-readable RTL structure/timing axes. | Classic still wins mean HV, HV-AUC, and aggregate front points; T64 improves yield but weakens front evidence. |
...
generator/archive coupling or use the descriptors as secondary/reporting cells.
...
| --- | --- | --- | --- |
| RTL-native descriptors | Yosys-SOG/MasterRTL, RTLTimer timing-risk vectors, T15/T60/T61/T62/T63/T64 | Active mechanism | Strongest methodology story if it preserves meaningful RTL families while optimizing PPA; T63/T64 are useful diagnostics but do not beat classic headline front metrics. |
