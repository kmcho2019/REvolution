...
| 3 | T63 fused RTL-native QD | Mechanism ablation | Adds RTLLM front, unique-PPA, and reference-beating signal versus T51 while using reviewer-readable RTL structure/timing axes. | Classic still wins mean HV, HV-AUC, and aggregate front points; VerilogEval yield is weak. |
...
classic headline win. This is still more defensible than opaque embedding-only
...
| --- | --- | --- | --- |
| RTL-native descriptors | Yosys-SOG/MasterRTL, RTLTimer timing-risk vectors, T15/T60/T61/T62/T63 | Active mechanism | Strongest methodology story if it preserves meaningful RTL families while optimizing PPA; T63 adds live front-material signal versus T51 but does not beat classic. |
