...
| `T33` | `T33_qwen3_preprocessing_ladder_bd` | Learned-descriptor follow-up with T33a source inventory; tests Qwen3 canonical RTL, Yosys netlist, and structural-summary views before projection-head training. |
