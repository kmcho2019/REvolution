...
- Most recent pre-registered package:
  ...
  source inventory and T33b preprocessing cache are packaged).
- Next direction:
...
| `T33` | `T33_qwen3_preprocessing_ladder_bd` | Learned-descriptor follow-up with source inventory and preprocessing-view cache; tests Qwen3 canonical RTL, Yosys netlist, and structural-summary views before projection-head training. |
