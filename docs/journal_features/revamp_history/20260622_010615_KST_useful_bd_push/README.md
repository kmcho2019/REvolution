...
- Most recent package:
  ...
  classic-vs-SR-RFF live result, remaining comparator arms still pending).
...
| `T24` | `T24_sr_pareto_live_validation` | Partial classic-vs-SR-RFF live result; no final tier until remaining arms complete. |
