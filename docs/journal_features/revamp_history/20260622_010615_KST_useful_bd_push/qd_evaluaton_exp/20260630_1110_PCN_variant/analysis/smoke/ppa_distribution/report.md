...
| --- | --- | --- | ---: | --- |
| `RTLLM` | `Prob019_sub_64bit` | `combinational` | 234 | [figures/all_backends/RTLLM/Prob019_sub_64bit](figures/all_backends/RTLLM/Prob019_sub_64bit) |
| `RTLLM` | `Prob036_edge_detect` | `sequential` | 219 | [figures/all_backends/RTLLM/Prob036_edge_detect](figures/all_backends/RTLLM/Prob036_edge_detect) |
