...
| --- | --- | --- | ---: | --- |
| `RTLLM` | `Prob019_sub_64bit` | `combinational` | 170 | [figures/all_backends/RTLLM/Prob019_sub_64bit](figures/all_backends/RTLLM/Prob019_sub_64bit) |
| `RTLLM` | `Prob036_edge_detect` | `sequential` | 120 | [figures/all_backends/RTLLM/Prob036_edge_detect](figures/all_backends/RTLLM/Prob036_edge_detect) |
| `RTLLM` | `Prob045_alu` | `combinational` | 141 | [figures/all_backends/RTLLM/Prob045_alu](figures/all_backends/RTLLM/Prob045_alu) |
