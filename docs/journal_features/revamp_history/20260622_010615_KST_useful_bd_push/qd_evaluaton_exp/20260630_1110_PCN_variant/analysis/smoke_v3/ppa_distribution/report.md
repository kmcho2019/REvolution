...
| --- | --- | --- | ---: | --- |
| `RTLLM` | `Prob019_sub_64bit` | `combinational` | 174 | [figures/all_backends/RTLLM/Prob019_sub_64bit](figures/all_backends/RTLLM/Prob019_sub_64bit) |
| `RTLLM` | `Prob036_edge_detect` | `sequential` | 124 | [figures/all_backends/RTLLM/Prob036_edge_detect](figures/all_backends/RTLLM/Prob036_edge_detect) |
| `RTLLM` | `Prob045_alu` | `combinational` | 148 | [figures/all_backends/RTLLM/Prob045_alu](figures/all_backends/RTLLM/Prob045_alu) |
