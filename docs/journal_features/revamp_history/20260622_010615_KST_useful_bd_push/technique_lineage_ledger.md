...
| T33 | `L4` | Qwen3 normalized RTL/netlist preprocessing ladder. | T33a source inventory packaged; no measured embedding result yet. | `advance` | Run preprocessing, embedding, collapse, and replay diagnostics before projection-head training. |
