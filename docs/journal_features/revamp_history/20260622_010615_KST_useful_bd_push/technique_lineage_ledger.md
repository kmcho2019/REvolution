...
| `L7` | RTL-native descriptors | Use RTL operator graphs and timing-risk/path morphology as behavior axes. | T74 completed as a negative follow-up: rare near-front pair gating preserves coverage but worsens HV/yield versus T73. |
