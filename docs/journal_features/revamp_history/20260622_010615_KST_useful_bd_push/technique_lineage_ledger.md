...
| `L5` | Archive coupling and parent pressure | Preserve diversity while restoring hill-climbing pressure. | T41 wins traffic-light but loses ALU/multi-pipe; next test T42 initial sparse-yield gating. |
