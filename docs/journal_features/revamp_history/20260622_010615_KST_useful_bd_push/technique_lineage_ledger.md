...
| `L7` | RTL-native descriptors | Use RTL operator graphs and timing-risk/path morphology as behavior axes. | T64 improves valid-PPA yield, but classic still wins HV/HV-AUC/front metrics. |
