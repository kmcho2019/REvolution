...
| T48 | `L5/L6` | T26.1 low-probability two-parent fusion gated by near-front rank and descriptor compatibility. | Implementation ready; live result pending. | `advance` live run | Run the T47 hard/tuning comparator surface and package HV/HV-AUC, validity, parent-gate counters, and front plots. |
