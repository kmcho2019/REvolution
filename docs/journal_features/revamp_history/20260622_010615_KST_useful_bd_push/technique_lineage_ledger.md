...
| `L5` | Archive coupling and parent pressure | Preserve diversity while restoring hill-climbing pressure. | T31 is measured negative; next is front-preserving archive/emitter sampling, not direct fail-feedback repair. |
| `L6` | Lineage and emitter schedules | Bias exploration with repair dynamics, parent history, and adaptive emitters. | T31 shows fail-pool feedback alone does not repair P098 yield or preserve T26 pressure. |
