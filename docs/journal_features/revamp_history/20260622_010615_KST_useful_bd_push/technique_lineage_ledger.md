...
| T33 | `L4` | Qwen3 normalized RTL/netlist preprocessing ladder. | T33a source inventory and T33b view cache packaged; no measured embedding result yet. | `advance` | Run embeddings, collapse, and replay diagnostics before projection-head training. |
