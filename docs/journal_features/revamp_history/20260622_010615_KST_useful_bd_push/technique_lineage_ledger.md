...
| `L5` | Archive coupling and parent pressure | Preserve diversity while restoring hill-climbing pressure. | T49 is measured as `T0 mixed_diagnostic` after T48. |
| `L6` | Lineage and emitter schedules | Bias exploration with repair dynamics, parent history, and adaptive emitters. | T49 shows role separation needs explicit front preservation. |
