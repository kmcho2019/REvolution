...
| T16 | `L4` | DeepCell multiview. | Scaffolded candidate, not yet validated. | `advance` selectively | Use isolated uv envs or source checkouts as needed for external encoders. |
