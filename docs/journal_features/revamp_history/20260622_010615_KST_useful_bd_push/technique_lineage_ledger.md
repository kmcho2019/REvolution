...
| `L4` | Learned encoders | Test Qwen3, DeepGate, graph, sequence, and multimodal circuit embeddings. | Move beyond label-free whole-design Qwen projections to graph encoders or new training objectives. |
