...
| `L7` | RTL-native descriptors | Use RTL operator graphs and timing-risk/path morphology as behavior axes. | T73 is a matched source-aligned quantile-cell diagnostic: yield-positive, HV/front-breadth negative. |
