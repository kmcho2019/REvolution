...
| T33 | `L4` | Qwen3 normalized RTL/netlist preprocessing ladder. | T33a source inventory, T33b view cache, and T33c embeddings packaged; collapse/replay pending. | `advance` | Run collapse and replay diagnostics before projection-head training. |
