...
| T57 | `L5/L6` | T51 adaptive-rebin QD: keep T51 fixed and enable KS-triggered grid-quantile rebinning. | Pre-registered. | `advance` archive-mechanics ablation | Run seed `1001`; compare against classic, T51 off-mode, and T56 before any seed `1002`. |
