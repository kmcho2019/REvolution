...
Outcome: produce exactly one reproducible conclusion. A primary positive must
pass the frozen full-RTLLM promotion rules and the accepted held-out
reference-PPA gates against matched classic REvolution. A parity or secondary
result must be labeled supporting. A failed stop or final gate must produce a
negative closure. Performance failure is a valid completed result; do not tune
until a number wins.
