...
# --- Configuration ---
MODEL_NAME= "/project/cad-team/LX_Semicon/models/openai-gpt-oss-120b" #"/root/.cache/huggingface/models/Qwen3-235B-A22B-Instruct-2507-FP8" #"/root/.cache/huggingface/models/openai-gpt-oss-120b" #"openrouter/horizon-alpha" #"/root/.cache/huggingface/models/Qwen3-Coder-30B-A3B-Instruct" #"google/gemini-2.5-flash-lite"
BENCHMARKS="RTLLM" # VerilogEval-Spec-to-RTL"
API_BACKEND="vllm" # "vllm" #"openrouter"
PROBLEMS= "Prob001_zero Prob010_mt2015_q4a"
# "Prob001_zero Prob010_mt2015_q4a Prob052_gates100 Prob068_countbcd Prob096_review2015_fsmseq Prob116_m2014_q3 Prob129_ece241_2013_q8 Prob001_accu Prob021_counter_12 Prob022_ring_counter" # 10 example problems
...
SAVE_DIR="/home2/ywshim/cowork/REvolution/SAVE_DIR/rtl-llm-evo/exp/exp_${CUR_TIME}_${EDIT_MODE}_${POPULATION_POOL_MODE}"
