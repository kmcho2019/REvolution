...
- Journal-revamp onboarding (read in this order when implementing the TCAD goal):
  ...
  [docs/journal_features/revamp_history/20260720_191404_KST_tcad_revolution_extension/README.md](docs/journal_features/revamp_history/20260720_191404_KST_tcad_revolution_extension/README.md) is the active bounded TCAD extension program; H5 is the sole Wave 1 mechanism and its classic core must remain byte-identical;
