module gshare_predictor (
  ...
  wire [INDEX_BITS-1:0] index = predict_pc ^ predict_global_history_reg[6:0]; // Use only lower 7 bits of history
  ...
  always @(posedge clk or posedge areset) begin
    if (areset) begin
      ...
      if (predict_valid) begin
        ...
        predict_global_history_reg <= {predict_global_history_reg[5:0], predict_taken}; // Shift in new prediction
      end
