...
assign next_state = (state == 10'b0000000001) ? (in ? 10'b0000000010 : 10'b0000000001) :
                    ...
                    (state == 10'b0000100000) ? (in ? 10'b0010000000 : 10'b0001000000) :
                    (state == 10'b0001000000) ? (in ? 10'b1000000000 : 10'b0100000000) :
...
assign out2 = (state == 10'b0000000000 || state == 10'b0000000010) ? 1 : 0;
