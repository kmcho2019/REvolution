module TopModule (
  ...
  assign Count_next = (state == 10'b0100000000 && done_counting == 1'b0) ? 1'b1 : 1'b0;
  ...
  assign shift_ena = (state == 10'b0000000100 || state == 10'b0000001000 || state == 10'b0000010000 || state == 10'b0000100000) ? 1'b1 : 1'b0;
