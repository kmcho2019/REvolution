module TopModule (
  ...
  // Add two 1 bits at the LSB positions to make it 32 bits
  wire [31:0] extended_input;
  assign extended_input = {concatenated_input, 2'b01};

  // Split the 32-bit vector into four 8-bit output vectors
  assign {w, x, y, z} = extended_input;
