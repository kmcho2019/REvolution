...
typedef enum {WALK_LEFT, WALK_RIGHT, FALL_OR_DIG} State;
...
always @ (posedge clk) begin
    case (current_state)
        WALK_LEFT: begin
            ...
            else if (!ground) next_state <= FALL_OR_DIG;
            else if (dig) next_state <= FALL_OR_DIG;
        ...
        FALL_OR_DIG: begin
            ...
            else if (dig && ground) next_state <= FALL_OR_DIG;
            else next_state <= FALL_OR_DIG;
        end
    endcase
end
