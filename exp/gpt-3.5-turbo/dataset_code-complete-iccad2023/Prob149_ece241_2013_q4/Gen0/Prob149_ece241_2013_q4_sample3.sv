...
// State definitions
parameter IDLE = 2'b11; // No sensors asserted
parameter ABOVE_S3 = 2'b10; // Sensors s[1], s[2], s[3] asserted
parameter BTW_S3_S2 = 2'b01; // Sensors s[1], s[2] asserted
parameter BTW_S2_S1 = 2'b00; // Sensor s[1] asserted
