...
class Heuristic:
    ...
    def __init__(
        ...
        self.reward_from_parent: float = 0.0 # Reward obtained by the strategy that created this heuristic
...
class EoHEngine:
    ...
    def __init__(
        ...
        self.base_save_path: str = base_save_path if base_save_path else os.path.join(os.getcwd(), "verilog_eoh_results")
        self.benchmark_name: str = benchmark_name
        self.problem_name: str = problem_name
        self.benchmark_path: str = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "data", "bench", self.benchmark_name))
        ...
        self.num_offspring_lambda: int = population_size  # λ, number of offspring to generate
